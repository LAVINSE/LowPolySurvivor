...
public class Factory : MonoBehaviour
{
    ...
    {
        var Gameobj = Factory.CreateObject(Name, ParentObject, Pos, Scale, Rotate, WorldPositionStays);
    ...
    public static T CreateCloneObj<T>(string Name, GameObject OriginObject, GameObject ParentObject,
        Vector3 Pos, Vector3 Scale, Vector3 Rotate, bool WorldPositionStays = false) where T : Component
    {
        var Gameobj = Factory.CreateCloneObj(Name, OriginObject, ParentObject, Pos, Scale, Rotate, WorldPositionStays);
